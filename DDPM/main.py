...
def arg_parse():
    ...
    parser.add_argument('--noise_steps', default=100, type=int, help='frequency of sampling')
    # Training
    ...
    # path
    parser.add_argument("--dataset_path", default="", type=str, help="root of dataset dir")
    ...
    parser.add_argument("--result_path", default="img/", type=str, help="save img path")
