    ...
    def train(self, train_loader, test_loader, test_new_loader):
        ...
        for epoch in tqdm(range(self.n_epoch)):
            ...
            if test_score > best_test_score:
                ...
                path = os.path.join(self.args.model_path, "model_test.pth")
            ...
            if test_new_score > best_test_new_score:
                ...
                path = os.path.join(self.args.model_path, "model_test_new.pth")
                torch.save(self.ddpm.state_dict(), path)
            ...
            # save training model
            path = os.path.join(self.args.model_path, "model_latest_train.pth")
            torch.save(self.ddpm.state_dict(), path)
