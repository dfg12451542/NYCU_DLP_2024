...
if __name__ == '__main__':
    ...
    generator =GAN.GAN_generate(args).to(device)
    discriminator = GAN.GAN_discriminate(args).to(device)

    generator.load_state_dict(torch.load('/home/adsl-1-3/Documents/DLP/Lab6/checkpoints_test2/netG.pth'))
    discriminator.load_state_dict(torch.load('/home/adsl-1-3/Documents/DLP/Lab6/checkpoints_test2/netD.pth'))
